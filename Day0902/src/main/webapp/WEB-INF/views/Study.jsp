...
<head>
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			var button2 = el_list[1].getElementsByClassName("complete-check-cover")[0];
			button2.onclick = function() {
				el_list[1].classList.add("is-completed");
			}
			var title2 = el_list[1].getElementsByClassName("title-cover")[0];
			...
			var button3 = el_list[2].getElementsByClassName("complete-check-cover")[0];
			button3.onclick = function() {
				el_list[2].classList.add("is-completed");
			}
			
			var title3 = el_list[2].getElementsByClassName("title-cover")[0];
			title3.onclick = function() {
				var iframe = $("div.note-content>div.markdown-body>div.iframe_container>iframe");
				iframe.src = "https://player.vimeo.com/video/471228776";
			}
			// 4회 타이틀
			var button4 = el_list[3].getElementsByClassName("complete-check-cover")[0];
			button4.onclick = function() {
				el_list[3].classList.add("is-completed");
			}
			var title4 = el_list[3].getElementsByClassName("title-cover")[0];
			...
			// 5회 타이틀
			var button5 = el_list[4].getElementsByClassName("complete-check-cover")[0];
			button5.onclick = function() {
				el_list[4].classList.add("is-completed");
			}
			var title5 = el_list[4].getElementsByClassName("title-cover")[0];
			...
			// 6회 타이틀
			var button6 = el_list[5].getElementsByClassName("complete-check-cover")[0];
			button6.onclick = function() {
				el_list[5].classList.add("is-completed");
			}
			var title6 = el_list[5].getElementsByClassName("title-cover")[0];
			...
			// 7회 타이틀
			var button7 = el_list[6].getElementsByClassName("complete-check-cover")[0];
			button7.onclick = function() {
				el_list[6].classList.add("is-completed");
			}
			var title7 = el_list[6].getElementsByClassName("title-cover")[0];
			...
			// 8회 타이틀
			var button8 = el_list[7].getElementsByClassName("complete-check-cover")[0];
			button8.onclick = function() {
				el_list[7].classList.add("is-completed");
			}
			var title8 = el_list[7].getElementsByClassName("title-cover")[0];
			...
			// 9회 타이틀
			var button9 = el_list[8].getElementsByClassName("complete-check-cover")[0];
			button9.onclick = function() {
				el_list[8].classList.add("is-completed");
			}
			var title9 = el_list[8].getElementsByClassName("title-cover")[0];
			...
			// 10회 타이틀
			var button10 = el_list[9].getElementsByClassName("complete-check-cover")[0];
			button10.onclick = function() {
				el_list[9].classList.add("is-completed");
			}
			var title10 = el_list[9].getElementsByClassName("title-cover")[0];
		...
		$(function() {
			var el_list = document.getElementsByClassName("infd-button is-basic-gray700 is-p-14 confirm e-confirm");
...
<div class="list-content e-border-scroll-content">
  <div class="curriculum-list">
  	<div class="section-el">サイコだけど大丈夫</div>
		...
		<div class="unit-el   " data-id="16255">
  			<div class="complete-check-cover">
    			<span class="infd-icon circle">
...
</div><div class="unit-el   " data-id="16256">
  <div class="complete-check-cover">
    <span class="infd-icon circle">
    <svg width="12" fill="#ffffff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 14"><path fill="#ffffff"fill-rule="evenodd" d="M16.08.14L5.725 10.599 1.92 6.756c-.185-.187-.484-.187-.668 0L.138 7.88c-.184.187-.184.489 0 .675l5.253 5.305c.184.187.483.187.668 0L17.862 1.94c.184-.187.184-.49 0-.676L16.748.14c-.184-.187-.483-.187-.668 0z"/></svg>
    </span>
...
</div><div class="unit-el   " data-id="16258">
  <div class="complete-check-cover">
    <span class="infd-icon circle">
    <svg width="12" fill="#ffffff" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 14"><path fill="#ffffff"fill-rule="evenodd" d="M16.08.14L5.725 10.599 1.92 6.756c-.185-.187-.484-.187-.668 0L.138 7.88c-.184.187-.184.489 0 .675l5.253 5.305c.184.187.483.187.668 0L17.862 1.94c.184-.187.184-.49 0-.676L16.748.14c-.184-.187-.483-.187-.668 0z"/></svg>
    </span>
...
<aside class="aside-container tab-content memo-container tab-toggle "
  ...
  <div class="aside-content" data-loading="true">
<div class="list-content e-border-scroll-content is-empty " data-loading="true">
 <a href="/note/noteList"> <br><br>노트 </a>
 
</div>
<div class="add-content">
  
 	
    <div class="course-editor comment-editor add-mm-post on-block-content"  data-type="ノート" data-action="作成">
